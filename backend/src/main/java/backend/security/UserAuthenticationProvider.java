...
import backend.repository.UserRoleRepository;
...
public class UserAuthenticationProvider implements ReactiveAuthenticationProvider<HttpRequest<?>, Object, Object> {
    ...
    private final DirectoryProfileRepository directoryRepository;
    private final UserRoleRepository userRoleRepository;
    private final RolePermissionRepository rolePermissionRepository;
    private final PermissionRepository permissionRepository;
    private final RoleRepository roleRepository;

    public UserAuthenticationProvider(UserAccountRepository userRepository, 
                                      DirectoryProfileRepository directoryRepository,
    ...
    public Publisher<AuthenticationResponse> authenticate(
        ...
        return Mono.fromCallable(() -> {
            ...
            // Try AD servers
            Iterable<DirectoryProfile> profiles = directoryRepository.findAll();
            for (DirectoryProfile profile : profiles) {
    ...
    private boolean tryAdAuth(String username, String password, DirectoryProfile profile) {
